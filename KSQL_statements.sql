...
CREATE STREAM SAFE_COUNT_STREAM
    AS SELECT     
        MAX(ROWTIME) AS RECORD_TIME, ASSIGN_LING_MD('safe:TR_F;20;30;70;80/alarm:TR_F;40;50;80;90', s.TRACTION, 0.99) AS STATE_NAME, COUNT(s.TRACTION) AS SAFE_COUNTER
...
CREATE STREAM ALARM_COUNT_STREAM
    AS SELECT     
        MAX(ROWTIME) AS RECORD_TIME, ASSIGN_LING_MD('safe:TR_F;20;30;70;80/alarm:TR_F;40;50;80;90', s.TRACTION, 0.99) AS STATE_NAME, COUNT(s.TRACTION) AS SAFE_COUNTER
        FROM AGV_1_STREAM_wu s
            WINDOW TUMBLING(SIZE 30 SECONDS)
