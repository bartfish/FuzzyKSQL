...
within 7 days 
on 
ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', a.CumulativeEnergyConsumption1, 0.3) = ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.3)
emit changes;
...
-- 6 - CRISP STATE DETECTION
CREATE TABLE CRISP_STATE_DETECTION AS
SELECT     
      TIMESTAMPTOSTRING(WINDOWSTART,'yyyy-MM-dd HH:mm:ss','Europe/London') AS WINDOW_START_TS,  
      s.CumulativeEnergyConsumption1 AS STATE_NAME,
      COUNT(s.CumulativeEnergyConsumption1) AS SAFE_COUNTER
    FROM NEW_AGV_1_STREAM s 
    WINDOW HOPPING(SIZE 1 MINUTE, ADVANCE BY 10 SECONDS)            
    GROUP BY s.CumulativeEnergyConsumption1
    HAVING COUNT(s.CumulativeEnergyConsumption1) > 0
   EMIT CHANGES;
...
SELECT 
    ...
    WINDOW_START_TS,
    SAFE_COUNTER
    FROM CRISPSTATE_DETECTION
    EMIT CHANGES; 


-- join na energii w czasie
SELECT 
    a.CumulativeEnergyConsumption1,
    b.CumulativeEnergyConsumption1,
    ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', a.CumulativeEnergyConsumption1, 0.9) as linguisticA,
    ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) as linguisticB,
    (CASE WHEN (ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) = 'high') THEN 'RED LIGHT ON' ELSE 'GREEN LIGHT ON' END) AS AGV_LIGHTS,
    (CASE WHEN (ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) = 'high') THEN 'LIDAR OFF' ELSE 'LIDAR ON' END) AS LIDAR_MEAS,
    (CASE WHEN (ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) = 'high') THEN 'TEMP SENSOR OFF' ELSE 'TEMP SENSOR ON' END) AS TEMP_MEAS,
    (CASE WHEN (ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) = 'high') THEN 'HUMIDITY SENSOR OFF' ELSE 'HUMIDITY SENSOR ON' END) AS HUMIDITY_MEAS,
    (CASE WHEN (ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.99) = 'high') THEN 'POWER OFF' ELSE 'POWER ON' END) AS POWER_STATUS
FROM NEW_AGV_1_STREAM a 
INNER JOIN NEW_AGV_2_STREAM b 
WITHIN 7 DAYS 
ON 
ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', a.CumulativeEnergyConsumption1, 0.9) = ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) 
WHERE ASSIGN_LING_MD('low:TR_F;500;1500;2000;2500/normal:TR_F;2100;2400;3000;3500/high:TR_F;3900;4200;4500;5000', b.CumulativeEnergyConsumption1, 0.9) != 'none' 
EMIT CHANGES;
